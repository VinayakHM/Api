...
- Name: bookings.spec.ts >> Booking API - GetBooking @booking >> GET /booking/:id with valid Accept header application/json @regression
- Location: tests/bookings.spec.ts:167:7
