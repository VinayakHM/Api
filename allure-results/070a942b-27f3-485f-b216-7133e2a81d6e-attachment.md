...
- Name: booking-create-update.spec.ts >> Booking API - CreateBooking & UpdateBooking @booking >> PUT /booking/:id with negative ID @edge-case
- Location: tests/booking-create-update.spec.ts:686:7
