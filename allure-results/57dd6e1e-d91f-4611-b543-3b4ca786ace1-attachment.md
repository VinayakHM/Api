...
- Name: bookings.spec.ts >> Booking API - GetBooking @booking >> GET /booking/:id checkout date is after or equal to checkin date @smoke
- Location: tests/bookings.spec.ts:121:7
