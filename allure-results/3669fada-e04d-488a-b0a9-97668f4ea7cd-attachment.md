...
- Name: booking-create-update.spec.ts >> Booking API - CreateBooking & UpdateBooking @booking >> POST /booking with invalid checkin date format @regression
- Location: tests/booking-create-update.spec.ts:257:7
