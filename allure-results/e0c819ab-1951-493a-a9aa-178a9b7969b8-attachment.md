...
- Name: bookings.spec.ts >> Booking API - GetBooking @booking >> GET /booking/:id has correct firstname and lastname types @smoke
- Location: tests/bookings.spec.ts:74:7
